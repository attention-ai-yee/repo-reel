...
2. 直接说明项目做什么、有什么用、为什么值得关注；语气像熟悉开源项目的中文主播。
3. 禁止使用：不是、而是、不等于、说白了、真正、本质上、换句话说、值得注意的是。
4. 不逐项朗读精确增星数；项目有明确的路线图、平台限制或已知缺口时，用观众听得懂的话点出来。
...
11. 口播面向观众，只讲项目本身。严禁出现幕后元信息词汇：事实包、摘要、缺席、没展开、
   待补全、线索偏少、信息入口、资料、文档密度、看不见、待观察、未提供。事实包里没有的信息，
   就直接不写那一点，绝不要评论「资料不全」这件事；用已有的事实把项目核心价值讲清楚即可。
{feedback_text}
唯一事实包：
{compact_dossier}"""
